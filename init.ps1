...
Add-HostsEntry "cm.sugcon_send.localhost"
Add-HostsEntry "cd.sugcon_send.localhost"
Add-HostsEntry "id.sugcon_send.localhost"
Add-HostsEntry "www.sugcon_send.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.sugcon_send.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.sugcon_send.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.sugcon_send.localhost"
